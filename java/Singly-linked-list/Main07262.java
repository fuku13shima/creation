...
//名前を表示するメソッド
	...
	//名前を逆順に表示しようとしたらnullがでてしまってなおせませんでした
	
//リストの最後尾を探し、前アドレスを返すメソッド
		public static int lastList(StudentData[] st,int seek){
